...
GLUSboolean init(GLUSvoid)
{
    ...
    glBufferData(GL_ELEMENT_ARRAY_BUFFER, g_numberIndices * sizeof(GLuint), (GLuint*) planeIndices, GL_STATIC_DRAW);
...
GLUSboolean update(GLUSfloat time)
{
	...
	glDrawElements(GL_PATCHES, g_numberIndices, GL_UNSIGNED_INT, 0);
